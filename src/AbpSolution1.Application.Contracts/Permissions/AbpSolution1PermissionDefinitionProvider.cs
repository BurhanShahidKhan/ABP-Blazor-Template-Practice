...
public class AbpSolution1PermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var toDoItemsPermission = myGroup.AddPermission(AbpSolution1Permissions.TodoItems.Default, L("Permission:ToDoItems"));
        booksPermission.AddChild(AbpSolution1Permissions.TodoItems.Create, L("Permission:ToDoItems.Create"));
        booksPermission.AddChild(AbpSolution1Permissions.TodoItems.Edit, L("Permission:ToDoItems.Edit"));
        booksPermission.AddChild(AbpSolution1Permissions.TodoItems.Delete, L("Permission:ToDoItems.Delete"));
